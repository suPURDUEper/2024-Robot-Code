...
public class TwoDisk extends ParallelCommandGroup {
  ...
  public TwoDisk(
    ...
    Pose2d startingPose = new Pose2d(toFirstDisk.getPreviewStartingHolonomicPose().getTranslation(), startingHeading);

    addCommands(
        Commands.runOnce(
            () -> drivetrain.seedFieldRelative(AllianceFlipUtil.apply(startingPose))),
