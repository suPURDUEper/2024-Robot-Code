...
public class ThreeDiskSource extends SequentialCommandGroup {

  public ThreeDiskSource(
    ...
    PathPlannerPath toThirdDisk = PathPlannerPath.fromChoreoTrajectory("5 source side.3");
    ...
    addCommands(
        ...
        Autos.aimAndFireNoElevator(drivetrain, shooterTilt, elevator, shooter, limelight, intake, 0.6));
  }
}
