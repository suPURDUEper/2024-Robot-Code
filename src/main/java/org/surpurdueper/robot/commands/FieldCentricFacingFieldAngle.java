...
public class FieldCentricFacingFieldAngle extends FieldCentricFacingAngle {
...
@Override
  public StatusCode apply(SwerveControlRequestParameters parameters, SwerveModule... modulesToApply) {
    if (ForwardReference == SwerveRequest.ForwardReference.OperatorPerspective) {
      ...
      this.TargetDirection = this.fieldCentricTargetDirection.minus(parameters.operatorForwardDirection);
    }
...
public FieldCentricFacingFieldAngle withFieldCentricTargetDirection(Rotation2d fieldCentricTargetDirection) {
