...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    joystick2.back().and(joystick2.y()).whileTrue(shooterTilt.goToPosition(Constants.TiltConstants.kWallShot));
    joystick2.back().and(joystick2.x()).whileTrue(shooterTilt.goToPosition(Constants.TiltConstants.kStageShot));
