...
import org.frc3005.lib.controller.PIDGains;
import org.frc3005.lib.monitor.HealthMonitor;
import org.frc3005.lib.util.AccessOrderHashSet;
import org.frc3005.lib.util.Constraints;
...
public class SparkMax extends CANSparkMax {
   ...
   * @return
   */
  public SparkMaxController positionController(PIDGains gains) {
    return new SparkMaxController(
   ...
   * @return
   */
  public SparkMaxController positionController(PIDGains gains, MotorFeedbackSensor sensor) {
   ...
   * @return
   */
  public SparkMaxController profiledController(PIDGains gains, Constraints constraints) {
    mutate(
        (sparkMax, firstCall) -> {
          int errors = 0;
          errors +=
